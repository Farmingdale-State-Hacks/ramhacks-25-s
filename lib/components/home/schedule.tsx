...
export const Schedule: React.FC = () => {
  ...
  const firstDaySchedule = [
    ...
    },
    {
      ...
      description: "Fuel up for the night ahead",
    },
  ];
  ...
  const secondDaySchedule = [
    {
      time: "8:00 AM",
      event: "Breakfast",
      description: "Start the second day with energy",
    },
    {
      time: "10:00 AM",
      event: "Hacking Ends",
            ...
            <Table>
              ...
              <TableBody>
                {scheduleItems.map((item, index) => (
                  ...
                  >
                    <TableCell className="font-medium text-ramhacks-orange">
                      {item.time}
                    </TableCell>
                    <TableCell className="font-semibold text-ramhacks-navy">
                      {item.event}
                    </TableCell>
