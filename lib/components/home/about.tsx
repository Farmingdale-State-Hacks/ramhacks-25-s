    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-ramhacks-navy mb-4">About RamHacks</h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            RamHacks is a student-run hackathon organization at Farmingdale State College.
            Our mission is to inspire innovation, foster collaboration, and build a vibrant tech community on campus.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-t-fshacks-orange">
            <CardContent className="pt-6">
              ...
              <h3 className="text-xl font-semibold text-center mb-2">Connect & Collaborate</h3>
              <p className="text-gray-600 text-center">
        ...
        <div className="mt-16 bg-fshacks-gray rounded-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-fshacks-blue mb-2">Healthcare Innovation</h4>
              <p className="text-gray-600">
                Develop solutions to improve healthcare access, patient experience, or medical technology.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-fshacks-blue mb-2">Sustainability Tech</h4>
              <p className="text-gray-600">
                Create projects that address environmental challenges and promote sustainable practices.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h4 className="text-xl font-semibold text-fshacks-blue mb-2">Education Technology</h4>
              <p className="text-gray-600">
